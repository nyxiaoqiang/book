...
public class BookBizImpl implements BookBiz {
	...
	@Override
	public BookVo getBookByTid(String tid) {
		BookAddDao bookAddDao = new BookAddDaoImpl();
		return bookAddDao.getEdit(tid);
	}

	@Override
	public boolean saveEditBook(BookVo bookVo, int tid) {
		BookAddDao bookAddDao = new BookAddDaoImpl();
		return bookAddDao.saveEdit(bookVo,tid);
	}
